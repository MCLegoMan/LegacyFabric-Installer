...
package net.legacyfabric.installer;
...
import net.legacyfabric.installer.client.ClientHandler;
import net.legacyfabric.installer.server.ServerHandler;
import net.legacyfabric.installer.util.ArgumentParser;
import net.legacyfabric.installer.util.CrashDialog;
import net.legacyfabric.installer.util.FabricService;
import net.legacyfabric.installer.util.MetaHandler;
import net.legacyfabric.installer.util.OperatingSystem;
